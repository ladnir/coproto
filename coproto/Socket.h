...
namespace coproto
{
    ...
    public:
        ...
        Socket(AsyncSocket & s)
            :mImpl(make_unique<SockScheduler>(s))
        {}
        ...
        std::unique_ptr<SockScheduler> mImpl;
        ...
        public:
            ...
            error_code resume_(Scheduler& sched) override {
                ...
                if (mStatus == Status::Uninit)
                {
                    ...
                    mSock->recv(sched, this, getSlot(), this);
                }
        ...
        public:
            ...
            RefRecvProto(SockScheduler* s, Container& t)
                : mSock(s)
                , mContainer(t)
            {
#ifdef COPROTO_LOGGING
        ...
        public:
            ...
            SpanRecvProto(SockScheduler* s, span<T> t)
                : mSock(s)
                , mContainer(t)
            {
#ifdef COPROTO_LOGGING
        ...
        public:
            ...
            RefSendProto(SockScheduler* s, Container& t)
                : mSock(s)
                , mContainer(t)
            {
#ifdef COPROTO_LOGGING
            ...
            error_code resume_(Scheduler& sched) override
            {
                if (mStatus == Status::Uninit)
                {
                    ...
                    {
                        mStatus = Status::Inprogress;
                        mSock->send_(sched, getBuffer(), getSlot(), this);
                    }
                }
                else if (mStatus == Status::Inprogress)
                {
        ...
        public:
            ...
            SpanSendProto(SockScheduler* s, span<T> t)
                : mSock(s)
                , mContainer(t)
            {
#ifdef COPROTO_LOGGING
        ...
        public:
            ...
            MvSendProto(SockScheduler* s, Container&& t)
                : mSock(s)
            ...
            error_code resume_(Scheduler& sched) override {
                ...
                {
                    mSock->send_(sched, getBuffer(), getSlot(), nullptr);
                    mEc = code::success;
                    sched.fulfillDep(*this, mEc, nullptr);
                }
                return mEc;
        ...
        Proto send(span<T> t)
        {
            ...
            ProtoV<void> proto;
            proto.mBase.emplace<SpanSendProto<T>>(mImpl.get(), t);
            return proto;
        }
        ...
        {
            ProtoV<void> proto;
            proto.mBase.emplace<RefSendProto<Container>>(mImpl.get(), t);
            return proto;
        }
        ...
        {
            ProtoV<void> proto;
            proto.mBase.emplace<MvSendProto<Container>>(mImpl.get(), std::forward<Container>(t));
            return proto;
        }
        ...
        Proto recv(span<T> t)
        {
            ...
            ProtoV<void> proto;
            proto.mBase.emplace<SpanRecvProto<T>>(mImpl.get(), t);
            return proto;
        }
        ...
        {
            ProtoV<void> proto;
            proto.mBase.emplace<RefRecvProto<Container, false>>(mImpl.get(), t);
            return proto;
        }
        ...
        {
            ProtoV<void> proto;
            proto.mBase.emplace<RefRecvProto<Container, true>>(mImpl.get(), t);
            return proto;
        }
