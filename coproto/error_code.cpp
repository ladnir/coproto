...
namespace { // anonymous namespace
    ...
    struct coprotoCodeCategory : std::error_category
    {
        ...
        std::string message(int err) const override
        {
            ...
            //    return  "coproto::code::bufferResizeNotMultipleOfValueType: Data was received over the connection and the receiver buffer was resized. However, the receiver buffer "
            ...
            case coproto::code::secuirtyViolation:
                return "coproto::code::secuirtyViolation: One of the other parties was caught cheating.";
            case coproto::code::parsingError:
                return "coproto::code::parsingError: An error occured while paring one of the protocol messages.";
            case coproto::code::protocolError:
                return "coproto::code::protocolError: An error occured durring the protocol such as a messages being of the wrong size.";
